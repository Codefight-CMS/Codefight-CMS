...
<div class="siteContainer">
    ...
    <div class="header">
        ...
        <div class="google_468_60_top"><?php Library('block')->load('advertisements/banner_468x60'); //Load Banner 468 X 60 block ?></div>
    ...
    <div class="pageContainer">
        ...
        <div class="menuLeft">
            ...
            <?php Library('block')->load('advertisements/banner_160x600'); //Load Banner 160 X 600 block ?>
