...
class Asset_Library extends MY_Library
{
    ...
    /*
      ...
      */
    public function get_path_url($file = 'cf', $type = 'css')
    {
    ...
    public function echo_combined($files = array(), $type = 'css', $media = 'all')
    {
        ...
        if (is_file($destination_dir . $file_name . '.' . $type)) {
            if ($type == 'css') {
                echo"\n" . '<link rel="stylesheet" href="' . $this->base_url . $this->assets_dir . $cache_path
                    . $this->cache_dir . '/' . $file_name . '.' . $type . '" type="text/css" media="' . $media
                    . '" />';
            }
            else {
                echo"\n" . '<script type="text/javascript" src="' . $this->base_url . $this->assets_dir
                    . $cache_path
                    . $this->cache_dir . '/' . $file_name . '.' . $type . '"></script>';
            }
        }
    }
