...
<div class="group_create">
    ...
    <p class="clear">&nbsp;</p>
    <label><?php echo __('NAME'); ?>:</label><input class="form-control txtFld" name="group[<?php echo $k; ?>][form_group_name]" type="text"
                               id="group_<?php echo $k; ?>_form_group_name"
                               value="<?php echo $v['form_group_name']; ?>"/>
    <p class="clear">&nbsp;</p>
    <label><?php echo __('IDENTIFIER'); ?>:</label><input class="form-control txtFld" name="group[<?php echo $k; ?>][form_group_identifier]" type="text"
                                     id="group_<?php echo $k; ?>_form_group_identifier"
                                     value="<?php echo $v['form_group_identifier']; ?>"/>
    <p class="clear">&nbsp;</p>
    <label><?php echo __('SEND TO'); ?>:</label><input class="form-control txtFld" name="group[<?php echo $k; ?>][form_group_send_to]" type="text"
