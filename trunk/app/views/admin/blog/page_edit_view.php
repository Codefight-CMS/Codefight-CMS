...
<div class="page_create">
    ...
    <div class="left">
        <label><?php echo __('PAGE ID') ?>:</label><input class="form-control txtFld" readonly="readonly"
    ...
    <p class="clear">&nbsp;</p><br/>
        ...
        <?php echo form_dropdown('page[' . $k . '][user_id]', $authors_list, $v['user_id'], 'class="form-control txtFld"'); ?>
	&nbsp;&nbsp;<?php echo __('Show Author') ?>&nbsp;<input type="checkbox" value="1"<?php if ($v['show_author']) {
		...
		<input class="form-control txtFld" name="page[<?php echo $k; ?>][page_author]"
    ...
    <label><?php echo __('TAGS') ?>:</label><input class="form-control txtFld" name="page[<?php echo $k; ?>][page_tag]" type="text"
