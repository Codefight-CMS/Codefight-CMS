...
--
-- Host: localhost
-- Generation Time: Jan 11, 2012 at 08:42 AM
...
(2, 'Public', 'General users go to this group.', 3),
(3, 'Registered User', 'Registered User Group.', 2),
(4, 'Authors', 'Give access to only certain areas for authors like article/cms sections.', 1);
...
(117, 1, 0, 'twitter', NULL, 'Twitter', 'blog', '', '', '', 8, ',2,'),
...
INSERT INTO `cf_user` (`user_id`, `active`, `email`, `password`, `firstname`, `lastname`, `group_id`, `is_admin`, `is_author`, `profile_link`) VALUES
(11, '1', 'test@test.com', '098f6bcd4621d373cade4e832627b4f6', 'Damodar', 'Bashyal', 1, 1, 1, 'https://plus.google.com/103583381097797606705'),
(46, '1', 'author@test.com', '098f6bcd4621d373cade4e832627b4f6', 'Author', 'Author', 4, 1, 1, NULL),
(47, '1', 'notauthor@test.com', 'test', 'Not', 'Author', 0, 0, 0, NULL);
