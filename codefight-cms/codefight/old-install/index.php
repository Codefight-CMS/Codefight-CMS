...
<p>NOTE:: If you already have existing install, Please backup Database Before Continuing. Currently this installer doesn't support database upgrade to current installed version. It might wipe your database and do clean install.</p>
