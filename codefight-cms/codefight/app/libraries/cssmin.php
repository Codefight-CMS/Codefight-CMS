 ...
 * 
 * Minifies CSS, preserving comment as directed. Note: This port moves the Minify_CommentPreserver 
...
/*
	...
	'preserveComments'
	Boolean flag for preserving comment.  Only comment starting with /*! are preserved. 
	Defaults to true.
	...
	NOTE: Global setting override setting in individual calls.
	===============================================================================================
*/
 ...
 * comment and tokens, and some CSS value minimization, where practical.
...
class Minify_CSS {
     ...
     * 
     * 'preserveComments': (default true) multi-line comment that begin
    ...
    public static function minify($css, $options = array()) 
    {
        ...
        // recursive calls don't preserve comment
    ...
    protected static function _minify($css, $options) 
    {
        ...
        // apply callback to all valid comment (and strip out surrounding ws
        self::$_inHack = false;
    ...
    protected static function _commentCB($m)
    {
        ...
        return ''; // remove all other comment
    }
...
/**
 * Process a string in pieces preserving C-style comment that begin with "/*!"
 * 
 * @package Minify
 * @author Stephen Clay <steve@mrclay.org>
 */
class Minify_CommentPreserver {
    ...
    /**
     * Process a string outside of C-style comment that begin with "/*!"
     *
     * On each non-empty string outside these comment, the given processor 
     * function will be called. The first "!" will be removed from the 
     * preserved comment, and the comment will be surrounded by 
    ...
    /**
     * Extract comment that YUI Compressor preserves.
     * 
