...
<?php $this->load->view('admin/inc/template_top'); ?>
	...
	<div class="page_create">
		...
		<label>PUBLISHED DATE:</label><input class="txtFld" name="page[<?php echo $k; ?>][page_date]" type="text" id="page_<?php echo $k; ?>_page_date" value="<?php echo $v['page_date']; ?>" />
		<p class="clear">&nbsp;</p>
		
		<div style="display:none;">&nbsp;&nbsp;Show Date&nbsp;<input type="checkbox" value="1"<?php if($v['show_date']) {echo ' checked="checked"';} ?> id="page_<?php echo $k; ?>_show_date" name="page[<?php echo $k; ?>][show_date]" />
		...
		<p class="clear">&nbsp;</p>
		<label>&nbsp;</label><input name="edit" type="submit" id="edit" value="Update" />&nbsp;<?php echo anchor('admin/page','BACK'); ?>
