...
<div class="menu_grid">
    ...
    <ul id="sortme">
        <li id="exclude">
            <div class="floatLeft center block borderRightGrey bold menu_grid_heading_chkbox"><?php echo __('Select'); ?></div>
            <div class="floatLeft center block borderRightGrey bold menu_grid_heading_title"><?php echo __('Title'); ?></div>
            <div class="floatLeft center block borderRightGrey bold menu_grid_heading_title"><?php echo __('Link'); ?></div>
            <div class="floatLeft center block bold menu_grid_heading_title"><?php echo __('Websites'); ?></div>
        </li>
        <?php
                if (isset($menu) && is_array($menu) && count($menu) > 0) foreach ($menu as $g)
    {
        ...
        <li id="<?php echo $g['id']; ?>" class="sortitem">
            <div class="floatLeft center block borderRightGrey menu_grid_heading_chkbox">
                <input name="select[<?php echo $g['id']; ?>]" type="checkbox" id="select_<?php echo $g['id']; ?>"
                       value="<?php echo $g['id']; ?>"/>
            </div>
            <div class="floatLeft block borderRightGrey menu_grid_heading_title">
