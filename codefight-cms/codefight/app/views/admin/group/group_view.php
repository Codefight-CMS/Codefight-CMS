...
<?php $this->load->view('admin/inc/template_top'); ?>
	...
	<div class="group_grid">
		...
		<li>
			...
			<div class="floatLeft center block borderRightGrey bold group_grid_heading_title">TITLE</div>
			<div class="floatLeft block bold group_grid_heading_description">DESCRIPTION</div>
		</li>
		<?php foreach($group as $g) { ?>
		<li id="<?php echo $g['group_id']; ?>" class="sortitem">
		  <div class="floatLeft center block borderRightGrey group_grid_heading_chkbox">
			<input name="select[<?php echo $g['group_id']; ?>]" type="checkbox" id="select_<?php echo $g['group_id']; ?>" value="<?php echo $g['group_id']; ?>" />
		  </div>
