...
<?php $this->load->view('admin/inc/template_top'); ?>
	...
	<div class="file_grid">
		...
		<li>
			...
			<div class="floatLeft center block borderRightGrey file_grid_heading_status"><?php if($g['folder_status'] == '0') {$bulb = 'yellow';} else if($g['folder_status'] == '1') {$bulb = 'green';} else {$bulb = 'red';} ?><a href="<?php echo site_url('admin/file/folder-status/'.$g['folder_id'].'/'.$g['folder_status']); ?>"><img src="<?php echo base_url(); ?>assets/admin/img/icon_status_<?php echo $bulb; ?>.gif" alt="<?php echo $bulb; ?>" border="0" width="10" height="10" /></a></div>
            <div class="floatLeft center block borderRightGrey file_grid_heading_status"><a href="<?php echo site_url('admin/file/search-file/'.$g['folder_id']); ?>"><?php echo $this->cf_file_model->get_file_count($g['folder_id']); ?></a></div>
		</li>
		<?php } ?>
		</ul>
		<p class="clear">&nbsp;</p>
