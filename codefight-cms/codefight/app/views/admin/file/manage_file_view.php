...
<div class="file_grid">
    ...
    <ul>
        <li>
            ...
            <div class="floatLeft center block borderRightGrey bold file_grid_heading_title"><?php echo __('Title'); ?></div>
            <div class="floatLeft center block borderRightGrey bold file_grid_heading_title"><?php echo __('NAME'); ?></div>
            <div class="floatLeft center block borderRightGrey bold file_grid_heading_title"><?php echo __('FILE URL'); ?></div>
        ...
        <li>
            ...
            <div class="floatLeft block borderRightGrey file_grid_heading_title">
                &nbsp;<?php echo $g['file_title']; ?></div>
            <div class="floatLeft block borderRightGrey file_grid_heading_title"><a
                    href="<?php echo base_url() . $g['file_path'] . $g['file_name']; ?>"><?php echo $g['file_name']; ?></a>
            </div>
            <div class="floatLeft block borderRightGrey file_grid_heading_title">
                &nbsp;[*[BASE_URL]*]<?php echo $g['file_path'] . $g['file_name']; ?></div>
            <div class="floatLeft center block borderRightGrey file_grid_heading_status"><?php if ($g['file_status'] == '0') {
                $bulb = 'yellow';
