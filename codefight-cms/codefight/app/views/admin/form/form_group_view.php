...
<div class="group_grid">
    ...
    <ul id="sortme">
        <li>
            ...
            <div class="floatLeft center block borderRightGrey bold group_grid_heading_title"><?php echo __('NAME'); ?> (<?php echo __('identifier'); ?>)</div>
            <div class="floatLeft block bold group_grid_heading_description"><?php echo __('SEND TO'); ?></div>
        </li>
        ...
        <li id="<?php echo $g['form_group_id']; ?>" class="sortitem">
            <div class="floatLeft center block borderRightGrey group_grid_heading_chkbox">
                <input name="select[<?php echo $g['form_group_id']; ?>]" type="checkbox"
                       id="select_<?php echo $g['form_group_id']; ?>" value="<?php echo $g['form_group_id']; ?>"/>
            </div>
            <div class="floatLeft center block borderRightGrey group_grid_heading_title"><?php echo $g['form_group_name']; ?>
                (<?php echo $g['form_group_identifier']; ?>)
            </div>
