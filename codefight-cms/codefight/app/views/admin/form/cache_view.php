...
<div class="setting">
    <ul><?php // ?>
        <li>
            ...
            <label class="lblInner"><input type="radio" name="cache" id="cache" value="1"/>&nbsp;<?php echo __('YES'); ?></label>
        ...
        <li>
            ...
            <label class="lblInner"><input type="radio" name="template" id="template" value="1"/>&nbsp;<?php echo __('YES'); ?></label>
