...
<?php $this->load->view('admin/inc/template_top'); ?>
	...
	<div class="group_grid">
		...
		<li>
			...
			<div class="floatLeft center block borderRightGrey bold group_grid_heading_title">KEY</div>
			<div class="floatLeft block bold group_grid_heading_description">INFO</div>
		</li>
