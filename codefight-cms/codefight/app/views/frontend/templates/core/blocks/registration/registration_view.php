		...
		<div class="loginBgBottom">
			...
			<div class="loginBgTop">
				...
				<div class="loginBg">
					...
					<label for="First Name" class="txtFld">First Name:</label><input class="txtFld" name="firstname" type="text" id="firstname" value="<?php echo set_value('firstname');?>" />

					<label for="Last Name" class="txtFld">Last Name:</label><input class="txtFld" name="lastname" type="text" id="lastname" value="<?php echo set_value('lastname');?>" />

					<label for="Email Address" class="txtFld">Email Address:</label><input class="txtFld" name="email" type="text" id="email" value="<?php echo set_value('email');?>" />
