...
<script language="javascript">
    ...
    function set_language(lang, url) {
        if (lang == '') {
            ...
            jQuery('#loading_language').html('<p class="red"><img alt="<?php echo lang('processing_wait');?>" src="<?php echo skin_url('global/images','ajax-loader.gif') ?>" border="0" width="128" height="15"/></p>');
