...
(function() {
	...
	tinymce.create('tinymce.dom.DOMUtils', {
		...
		setHTML : function(e, h) {
			...
			return this.run(e, function(e) {
				...
				if (isIE) {
					function set() {
						try {
							// IE will remove comment from the beginning
							...
							// Create new div with HTML contents and a BR infront to keep comment
							x = t.create('div');
							x.innerHTML = '<br />' + h;
		...
		processHTML : function(h) {
			...
			if (s.keep_values) {
				// Wrap scripts and styles in comment for serialization purposes
